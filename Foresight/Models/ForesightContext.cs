...
{
    public partial class ForesightContext : DbContext
    {
        public ForesightContext()
        {
        }

        public ForesightContext(DbContextOptions<ForesightContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=foresightgc.database.windows.net;Database=Foresight;User ID=gcadmin;Password=October2019;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Form>(entity =>
            {
                ...
                entity.Property(e => e.Question3).HasMaxLength(256);

                entity.Property(e => e.Question4).HasMaxLength(256);

                entity.Property(e => e.Question5).HasMaxLength(256);

                entity.Property(e => e.Question6).HasMaxLength(256);

                entity.Property(e => e.Question7).HasMaxLength(256);

                entity.Property(e => e.Question8).HasMaxLength(256);
